...
{	
	...
	int counter=0; 
	//I am seg faulting somewhere in this while loop
	// I suspected it might be when I have 1 node or an 
	// empty list. I have accounted for these cases 
	//but still seg faulting...
	while (swatches.size() > 0)
	{
		...
		//cout << counter<< endl << swatches.size() << endl;
	}
	cout << endl << endl; // some space
